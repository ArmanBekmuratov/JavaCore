...
public class FileDemo {
    ...
    public static void main(String[] args) {
        File f1 = new File("C:\\Users\\abekm\\Desktop\\PASSWORDS.txt");
        ...
        p(f1.canRead() ? "доступен для чтения" : "не доступен для чтеия");
        p(f1.isDirectory() ? "являеется каталогом" : "не является каталогом");
